 ...
 */
final class Version20241226141853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__programa AS SELECT id, titulo, fecha, link, miniatura, edicion FROM programa');
        ...
        $this->addSql('INSERT INTO programa (id, titulo, fecha, link_youtube, miniatura, edicion) SELECT id, titulo, fecha, link, miniatura, edicion FROM __temp__programa');
        $this->addSql('DROP TABLE __temp__programa');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO invitado (apodo, rubro, id) SELECT apodo, rubro, id FROM __temp__invitado');
        $this->addSql('DROP TABLE __temp__invitado');
        $this->addSql('CREATE TEMPORARY TABLE __temp__programa AS SELECT id, titulo, fecha, link_youtube, miniatura, edicion FROM programa');
        $this->addSql('DROP TABLE programa');
        $this->addSql('CREATE TABLE programa (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titulo VARCHAR(255) NOT NULL, fecha DATE NOT NULL, link VARCHAR(255) NOT NULL, miniatura VARCHAR(255) NOT NULL, edicion VARCHAR(50) NOT NULL)');
        $this->addSql('INSERT INTO programa (id, titulo, fecha, link, miniatura, edicion) SELECT id, titulo, fecha, link_youtube, miniatura, edicion FROM __temp__programa');
        $this->addSql('DROP TABLE __temp__programa');
    }
}
